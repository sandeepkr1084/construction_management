...
<main>
    ...
    <?php 
    $sql = "SELECT * FROM our_services WHERE status=1 LIMIT 3;";
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-service-cap mb-30">
                        ...
                        <div class="service-cap">
                            <h4><a href="services_details.php?service_id=<?php echo $row["id"] ?>"><?php echo $row["title"] ?></a></h4>
            ...
            <div class="col-12">
                <div class="tab-content active" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade active show" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">   
                        <?php 
                        $sql = "SELECT * FROM our_projects WHERE status=1 LIMIT 6";
                        $result = $conn->query($sql);
                        ?>
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <?php 
                        $sql = "SELECT * FROM our_projects WHERE type='intorior' and status=1 LIMIT 6";
                        $result = $conn->query($sql);
                        ?>
                        <div class="project-caption">
                            <div class="row">
                    ...
                    <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                        <?php 
                        $sql = "SELECT * FROM our_projects WHERE status=1 ORDER BY id DESC LIMIT 6";
                        $result = $conn->query($sql);
                        ?>
                        <div class="project-caption">
                            <div class="row">
                    ...
                    <div class="tab-pane fade" id="nav-last" role="tabpanel" aria-labelledby="nav-last-tab">
                        <?php 
                        $sql = "SELECT * FROM our_projects WHERE type='big building' and status=1 LIMIT 6";
                        $result = $conn->query($sql);
                        ?>
                        <div class="project-caption">
                            <div class="row">
                    ...
                    <div class="tab-pane fade" id="nav-techno" role="tabpanel" aria-labelledby="nav-technology">
                        <?php 
                        $sql = "SELECT * FROM our_projects WHERE type='park' and status=1 LIMIT 6";
                        $result = $conn->query($sql);
                        ?>
                        <div class="project-caption">
                            <div class="row">
...
<?php 
$sql = "SELECT * FROM our_team WHERE status=1 LIMIT 3";
$result = $conn->query($sql);
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                <div class="single-team mb-30">
                    ...
                    <div class="team-caption">
                        ...
                        <h3><?php echo $row["first_name"]." ".$row["first_name"] ?></h3>
                    </div>
                </div>
            </div>
            <?php } ?>
...
<?php 
$sql = "SELECT * FROM blogs WHERE status=1 ORDER BY id DESC LIMIT 2";
$result = $conn->query($sql);
        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6">
                <div class="single-news mb-30">
                    <div class="news-img">
                        <img src="admin/<?php echo $row["image"] ?>" alt="" height="300px">
                        <div class="news-date text-center">
                            <span><?php echo $row["created_date"][0].$row["created_date"][1] ?></span>
                            <p><?php echo $row["created_date"][3].$row["created_date"][4].$row["created_date"][5] ?></p>
                        </div>
                    </div>
                    <div class="news-caption">
                        ...
                        <h2><a href="single-blog.php?blog_id=<?php echo $row["id"] ?>"><?php echo substr($row["title"],0, 70) ?></a></h2>
                        <a href="single-blog.php?blog_id=<?php echo $row["id"] ?>" class="d-btn">Read more »</a>
                    </div>
                </div>
            </div>
            <?php } ?>
